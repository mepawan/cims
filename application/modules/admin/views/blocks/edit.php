				...
				<section class="panel panel-with-borders">
					<div class="panel-heading">
						<div class="heading-buttons pull-right">
							<a href="<?php echo ci_base_url();?>pages/add" class="btn btn-success margin-inline update-block-button">Update</a>
						</div>
							...
							<form>
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input required type="text" name="title" id="title" class="form-control" placeholder="Block Title" value="<?php echo $page[0]['title']; ?>"> 
