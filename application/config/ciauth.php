...
$config['ciauth_email_template'] = array(
	...
	'provider_contact_request' => 'Dear {name},<br /><br />{name2} want to contact you on {site_name}}.<br /><br />Please login to you {site_name} account and respond him.<br /><br /> Thanks,<br />{site_name} Team<br />',
);
